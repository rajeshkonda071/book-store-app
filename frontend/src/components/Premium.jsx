    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 pb-20">
      ...
      <div className="pt-28 flex flex-col items-center text-center">
        ...
        <div className="mt-10 w-full max-w-md">
          <label className="input input-bordered flex items-center gap-2 dark:bg-slate-800 border-pink-500/30 focus-within:border-pink-500 transition-all">
            <input 
              type="text" 
              className="grow" 
        ...
        <Link to="/">
          <button className="mt-8 bg-pink-500 text-white px-8 py-2 rounded-full font-medium hover:bg-pink-700 transition-all duration-300 shadow-lg shadow-pink-500/20">
            Back to Home
          </button>
        </Link>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {filteredBooks.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20">
            <h2 className="text-xl text-gray-500 italic">No premium books found matching "{searchQuery}"</h2>
          </div>
        )}
      </div>
    </div>
